        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">
              {canViewValues ? `${summary.total_cost_basis.toLocaleString("vi-VN")} ₫` : "-"}
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {canViewValues ? `${summary.total_accumulated_depreciation.toLocaleString("vi-VN")} ₫` : "-"}
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              {canViewValues ? `${summary.total_nbv.toLocaleString("vi-VN")} ₫` : "-"}
            </div>
          </CardContent>
        </Card>
      </div>
              ...
              filteredSchedules.map((schedule) => (
                <TableRow key={schedule.id}>
                  ...
                  <TableCell className="text-right">
                    {canViewValues ? `${Number(schedule.depreciation_amount).toLocaleString("vi-VN")} ₫` : "-"}
                  </TableCell>
                  <TableCell className="text-right text-orange-600">
                    {canViewValues ? `${Number(schedule.accumulated_depreciation).toLocaleString("vi-VN")} ₫` : "-"}
                  </TableCell>
                  <TableCell className="text-right text-green-600 font-medium">
                    {canViewValues ? `${Number(schedule.nbv).toLocaleString("vi-VN")} ₫` : "-"}
                  </TableCell>
                  <TableCell>
