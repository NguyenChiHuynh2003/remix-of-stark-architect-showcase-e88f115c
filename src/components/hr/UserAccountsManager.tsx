...
import { Key, Trash2, Loader2, RefreshCw, Download } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={() => {
                ...
                const header = "STT,Họ tên,Email,Vai trò\n";
                const rows = users.map((u, i) => 
                  `${i + 1},"${u.full_name}","${u.email}","${roleLabels[u.role as AppRole] || u.role}"`
                ).join("\n");
                const bom = "\uFEFF";
